...
implementation of WebSockets that will resolve this issue which will be
added as soon as possible. As a temporary solution you can access
the reForis UI over `HTTP`.
